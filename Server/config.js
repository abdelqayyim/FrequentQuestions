...
const connectionURL = `mongosh "mongodb+srv://cluster0.sk7tl.mongodb.net/${dbname}" --apiVersion 1 --username abdel`; // full URL for connecting to our MongoDB database; includes the database username, password, and the database name
