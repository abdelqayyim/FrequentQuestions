/* PrismJS 1.27.0
https://prismjs.com/download.html#themes=prism-tomorrow&languages=markup+css+clike+javascript+c+csharp+cpp+go+java+json+json5+makefile+markdown+mongodb+python+sql+swift+typescript&plugins=line-numbers+show-language+jsonp-highlight+highlight-keywords+command-line+toolbar+copy-to-clipboard */
var _self =
